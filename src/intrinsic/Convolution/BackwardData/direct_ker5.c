...
)
{
  for (int64_t h = 0; h < gInHeight ; h++ ) {
	...
	if( (gOutChannelGroup & 0x01)  == 1 ) {
	  ...
	  __vr vrgout_ptr_k0_s1 = _ve_vsfa_vvss(_ve_vaddsl_vsv(gOutWidth*y, vrx_s1),
					     2,
					     (unsigned long)(pGOut+gOutIndex)) ;
	  __vr vrgout_k0_s1 = _ve_vgtu_vvm(vrgout_ptr_k0_s1, vmx_s1) ;
	  __vr vrgout_ptr_k0_s2 = _ve_vsfa_vvss(_ve_vaddsl_vsv(gOutWidth*y, vrx_s2),
					     2,
					     (unsigned long)(pGOut+gOutIndex)) ;
	  __vr vrgout_k0_s2 = _ve_vgtu_vvm(vrgout_ptr_k0_s2, vmx_s2) ;
	  __vr vrgout_ptr_k0_s3 = _ve_vsfa_vvss(_ve_vaddsl_vsv(gOutWidth*y, vrx_s3),
					     2,
					     (unsigned long)(pGOut+gOutIndex)) ;
	  __vr vrgout_k0_s3 = _ve_vgtu_vvm(vrgout_ptr_k0_s3, vmx_s3) ;
	  __vr vrgout_ptr_k0_s4 = _ve_vsfa_vvss(_ve_vaddsl_vsv(gOutWidth*y, vrx_s4),
					     2,
					     (unsigned long)(pGOut+gOutIndex)) ;
	  __vr vrgout_k0_s4 = _ve_vgtu_vvm(vrgout_ptr_k0_s4, vmx_s4) ;
