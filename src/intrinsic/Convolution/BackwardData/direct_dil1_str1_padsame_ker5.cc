...
#pragma clang loop unroll(full)
    ...
    __vm256 vmx_s0 =  _vel_vfmklgt_mvl(_vel_vcmpsl_vsvl(gOutWidth-2,vrix, vl), vl) ;
    __vm256 vmx_s1 =  _vel_vfmklgt_mvl(_vel_vcmpsl_vsvl(gOutWidth-1,vrix, vl), vl) ;
    __vm256 vmx_s3 =  _vel_vfmklge_mvl(_vel_vaddsl_vsvl(-1, vrix, vl), vl) ;
    __vm256 vmx_s4 =  _vel_vfmklge_mvl(_vel_vaddsl_vsvl(-2, vrix, vl), vl) ;
...
#define VFADD(VRGOUT,VM,K,R,S) {								\
	...
	VFADD(vrgout_s0, vmall_s0, k+0, r, 0) ;
	VFADD(vrgout_s1, vmall_s1, k+0, r, 1) ;
	VFADD(vrgout_s2, vmall_s2, k+0, r, 2) ;
	VFADD(vrgout_s3, vmall_s3, k+0, r, 3) ;
	VFADD(vrgout_s4, vmall_s4, k+0, r, 4) ;
