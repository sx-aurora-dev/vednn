...
#define VFADD(VRGOUT,K,R,S) {									\
	...
	if( ((gOutChannelGroup >> 2) & 0x01 ) == 1 ) {
	  ...
	  VFADD(vrgout_k0, k+0, r, s) ;
	  VFADD(vrgout_k1, k+1, r, s) ;
	  VFADD(vrgout_k2, k+2, r, s) ;
	  VFADD(vrgout_k3, k+3, r, s) ;
	...
	for (; k<gOutChannelGroup; k+=8) {
	  ...
	  VFADD(vrgout_k2, k+2, r, s) ;
	  VFADD(vrgout_k3, k+3, r, s) ;
	  VFADD(vrgout_k4, k+4, r, s) ;
	  VFADD(vrgout_k5, k+5, r, s) ;
	  VFADD(vrgout_k6, k+6, r, s) ;
	  VFADD(vrgout_k7, k+7, r, s) ;
