...
#pragma clang loop unroll(full)
	...
	__vr vrpin_c0 = _vel_vsfa_vvssl(vrhw, 2, (uint64_t)(pInChannel+0*inHeight*inWidth), vl) ;
...
#pragma clang loop unroll(full)
	...
	__vr vrpin_c0 = _vel_vsfa_vvssl(vrhw, 2, (uint64_t)(pInChannel+0*inHeight*inWidth), vl) ;
	__vr vrin_c0 = _vel_vgtu_vvssl(vrpin_c0, 0, 0, vl) ;
	__vr vrpin_c1 = _vel_vsfa_vvssl(vrhw, 2, (uint64_t)(pInChannel+1*inHeight*inWidth), vl) ;
...
#pragma clang loop unroll(full)
	...
	__vr vrpin_c1 = _vel_vsfa_vvssl(vrhw, 2, (uint64_t)(pInChannel+1*inHeight*inWidth), vl) ;
	__vr vrin_c1 = _vel_vgtu_vvssl(vrpin_c1, 0, 0, vl) ;
	__vr vrpin_c2 = _vel_vsfa_vvssl(vrhw, 2, (uint64_t)(pInChannel+2*inHeight*inWidth), vl) ;
	__vr vrin_c2 = _vel_vgtu_vvssl(vrpin_c2, 0, 0, vl) ;
	__vr vrpin_c3 = _vel_vsfa_vvssl(vrhw, 2, (uint64_t)(pInChannel+3*inHeight*inWidth), vl) ;
