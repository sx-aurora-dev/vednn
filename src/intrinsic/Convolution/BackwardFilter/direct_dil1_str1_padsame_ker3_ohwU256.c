...
//  const int64_t dilationHeight = pParamConv->dilationHeight;	/* must be 1 */
...
#endif
  {
    ...
    __vm256 vmh1_r2 = _ve_vfmkl_mcv(VECC_IG, _ve_vcmpsl_vsv(inHeight-1,vry)) ;	// condition(y+1< inHeight)
	...
	if ( (nOChannel & 0x01) == 1 ) {
	  for (int64_t c=0; c<inChannelGroup; c++) {
	    ...
	    for (int64_t n=0; n<batch; n++) {
	      ...
	      __vr vrin_r0s0    = _ve_vldu_vss(4,&pInChannel[-inWidth-1]) ;
	      __vr vrin_r0s1    = _ve_vldu_vss(4,&pInChannel[-inWidth  ]) ;
	      __vr vrin_r0s2    = _ve_vldu_vss(4,&pInChannel[-inWidth+1]) ;
	      __vr vrin_r1s0    = _ve_vldu_vss(4,&pInChannel[        -1]) ;
	      __vr vrin_r1s1    = _ve_vldu_vss(4,&pInChannel[         0]) ;
	      __vr vrin_r1s2    = _ve_vldu_vss(4,&pInChannel[        +1]) ;
	      __vr vrin_r2s0    = _ve_vldu_vss(4,&pInChannel[ inWidth-1]) ;
	      __vr vrin_r2s1    = _ve_vldu_vss(4,&pInChannel[ inWidth  ]) ;
	      __vr vrin_r2s2    = _ve_vldu_vss(4,&pInChannel[ inWidth+1]) ;
	    ...
	    vrsum_r0s0 = _ve_vfsums_vvm(vrsum_r0s0, vmall_r0s0) ;
	    vrsum_r0s1 = _ve_vfsums_vvm(vrsum_r0s1, vmall_r0s1) ;
	    vrsum_r0s2 = _ve_vfsums_vvm(vrsum_r0s2, vmall_r0s2) ;
	    vrsum_r1s0 = _ve_vfsums_vvm(vrsum_r1s0, vmall_r1s0) ;
	    vrsum_r1s1 = _ve_vfsums_vv(vrsum_r1s1) ;
	    vrsum_r1s2 = _ve_vfsums_vvm(vrsum_r1s2, vmall_r1s2) ;
	    vrsum_r2s0 = _ve_vfsums_vvm(vrsum_r2s0, vmall_r2s0) ;
	    vrsum_r2s1 = _ve_vfsums_vvm(vrsum_r2s1, vmall_r2s1) ;
	    vrsum_r2s2 = _ve_vfsums_vvm(vrsum_r2s2, vmall_r2s2) ;
...
{									\
  _ve_lvl(vl) ;								\
  __vr vrsumU_r0s0 = _ve_vfsums_vvm(VRSUMTOKEN ## _r0s0, vmall_r0s0) ;	\
  __vr vrsumU_r0s1 = _ve_vfsums_vvm(VRSUMTOKEN ## _r0s1, vmall_r0s1) ;	\
  __vr vrsumU_r0s2 = _ve_vfsums_vvm(VRSUMTOKEN ## _r0s2, vmall_r0s2) ;	\
  __vr vrsumU_r1s0 = _ve_vfsums_vvm(VRSUMTOKEN ## _r1s0, vmall_r1s0) ;	\
  __vr vrsumU_r1s1 = _ve_vfsums_vv(VRSUMTOKEN ## _r1s1) ;	\
  __vr vrsumU_r1s2 = _ve_vfsums_vvm(VRSUMTOKEN ## _r1s2, vmall_r1s2) ;	\
  __vr vrsumU_r2s0 = _ve_vfsums_vvm(VRSUMTOKEN ## _r2s0, vmall_r2s0) ;	\
  __vr vrsumU_r2s1 = _ve_vfsums_vvm(VRSUMTOKEN ## _r2s1, vmall_r2s1) ;	\
  __vr vrsumU_r2s2 = _ve_vfsums_vvm(VRSUMTOKEN ## _r2s2, vmall_r2s2) ;	\
  _ve_lvl(1) ;								\
...
#define VSUM_STORE_3X3_LOWER(VRSUMTOKEN, KERNELINDEX)					\
  {											\
  _ve_lvl(vl) ;										\
  __vr vrsumL_r0s0 = _ve_vfsums_vvm(_ve_vsll_vvs(VRSUMTOKEN ## _r0s0,32), vmall_r0s0) ;	\
  __vr vrsumL_r0s1 = _ve_vfsums_vvm(_ve_vsll_vvs(VRSUMTOKEN ## _r0s1,32), vmall_r0s1) ;	\
  __vr vrsumL_r0s2 = _ve_vfsums_vvm(_ve_vsll_vvs(VRSUMTOKEN ## _r0s2,32), vmall_r0s2) ;	\
  __vr vrsumL_r1s0 = _ve_vfsums_vvm(_ve_vsll_vvs(VRSUMTOKEN ## _r1s0,32), vmall_r1s0) ;	\
  __vr vrsumL_r1s1 = _ve_vfsums_vv(_ve_vsll_vvs(VRSUMTOKEN ## _r1s1,32)) ;		\
  __vr vrsumL_r1s2 = _ve_vfsums_vvm(_ve_vsll_vvs(VRSUMTOKEN ## _r1s2,32), vmall_r1s2) ;	\
  __vr vrsumL_r2s0 = _ve_vfsums_vvm(_ve_vsll_vvs(VRSUMTOKEN ## _r2s0,32), vmall_r2s0) ;	\
  __vr vrsumL_r2s1 = _ve_vfsums_vvm(_ve_vsll_vvs(VRSUMTOKEN ## _r2s1,32), vmall_r2s1) ;	\
  __vr vrsumL_r2s2 = _ve_vfsums_vvm(_ve_vsll_vvs(VRSUMTOKEN ## _r2s2,32), vmall_r2s2) ;	\
  _ve_lvl(1) ;										\
