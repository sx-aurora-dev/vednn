...
//  const int64_t dilationHeight = pParamConv->dilationHeight;	/* must be 1 */
...
#endif
  {
    ...
    __vm256 vmw0_s0 =  _vel_vfmklge_mvl(_vel_vaddsl_vsvl(-1, vrx, VLEN), VLEN) ;		// condition(  1<=x)
    __vm256 vmw1_s2 =  _vel_vfmklgt_mvl(_vel_vcmpsl_vsvl(inWidth-1,vrx, VLEN), VLEN) ;	// condition(x+1< inWidth)

    __vm256 vmh0_r0 =  _vel_vfmklge_mvl(_vel_vaddsl_vsvl(-1, vry, VLEN) , VLEN) ;	// condition(  1<=y)
    __vm256 vmh1_r2 =  _vel_vfmklgt_mvl(_vel_vcmpsl_vsvl(inHeight-1-last_y,vry, VLEN), VLEN) ;	// condition(y+1< inHeight)
	...
	if ( (nOChannel & 0x01) == 1 ) {
	  for (int64_t c=0; c<inChannelGroup; c++) {
		...
		__vr vrin_r0s0    = _vel_vldu_vssl(4,&pInChannel[gop-inWidth-1], vl) ;
		__vr vrin_r0s1    = _vel_vldu_vssl(4,&pInChannel[gop-inWidth  ], vl) ;
		__vr vrin_r0s2    = _vel_vldu_vssl(4,&pInChannel[gop-inWidth+1], vl) ;
		...
		vrin_r0s0 = _vel_vmrg_vvvml(_vel_vbrds_vsl(0.0f, vl), vrin_r0s0, vmall_r0s0, vl) ;
		vrsum_r0s0 = _vel_vfmads_vvvvvl(vrsum_r0s0, vrin_r0s0, vrgout, vrsum_r0s0, vl) ;
		vrin_r0s1 = _vel_vmrg_vvvml(_vel_vbrds_vsl(0.0f, vl), vrin_r0s1, vmall_r0s1, vl) ;
		vrsum_r0s1 = _vel_vfmads_vvvvvl(vrsum_r0s1, vrin_r0s1, vrgout, vrsum_r0s1, vl) ;
		vrin_r0s2 = _vel_vmrg_vvvml(_vel_vbrds_vsl(0.0f, vl), vrin_r0s2, vmall_r0s2, vl) ;
		...
		vrin_r2s0 = _vel_vmrg_vvvml(_vel_vbrds_vsl(0.0f, vl), vrin_r2s0, vmall_r2s0, vl) ;
		vrsum_r2s0 = _vel_vfmads_vvvvvl(vrsum_r2s0, vrin_r2s0, vrgout, vrsum_r2s0, vl) ;
		vrin_r2s1 = _vel_vmrg_vvvml(_vel_vbrds_vsl(0.0f, vl), vrin_r2s1, vmall_r2s1, vl) ;
		vrsum_r2s1 = _vel_vfmads_vvvvvl(vrsum_r2s1, vrin_r2s1, vrgout, vrsum_r2s1, vl) ;
		vrin_r2s2 = _vel_vmrg_vvvml(_vel_vbrds_vsl(0.0f, vl), vrin_r2s2, vmall_r2s2, vl) ;
		vrsum_r2s2 = _vel_vfmads_vvvvvl(vrsum_r2s2, vrin_r2s2, vrgout, vrsum_r2s2, vl) ;
	      }

	    } // batch

	    vrsum_r0s0 = _vel_vfsums_vvml(vrsum_r0s0, vmw0_s0, VLEN) ;
	    vrsum_r0s1 = _vel_vfsums_vvl(vrsum_r0s1, VLEN) ;
	    vrsum_r0s2 = _vel_vfsums_vvml(vrsum_r0s2, vmw1_s2, VLEN) ;
	    vrsum_r1s0 = _vel_vfsums_vvml(vrsum_r1s0, vmw0_s0, VLEN) ;
	    vrsum_r1s1 = _vel_vfsums_vvl(vrsum_r1s1, VLEN) ;
	    vrsum_r1s2 = _vel_vfsums_vvml(vrsum_r1s2, vmw1_s2, VLEN) ;
	    vrsum_r2s0 = _vel_vfsums_vvml(vrsum_r2s0, vmw0_s0, VLEN) ;
	    vrsum_r2s1 = _vel_vfsums_vvl(vrsum_r2s1, VLEN) ;
	    vrsum_r2s2 = _vel_vfsums_vvml(vrsum_r2s2, vmw1_s2, VLEN) ;
...
{									\
  __vr vrsumU_r0s0 = _vel_vfsums_vvml(VRSUMTOKEN ## _r0s0, vmw0_s0, VLEN) ;	\
  __vr vrsumU_r0s1 = _vel_vfsums_vvl(VRSUMTOKEN ## _r0s1, VLEN) ;		\
  __vr vrsumU_r0s2 = _vel_vfsums_vvml(VRSUMTOKEN ## _r0s2, vmw1_s2, VLEN) ;	\
  __vr vrsumU_r1s0 = _vel_vfsums_vvml(VRSUMTOKEN ## _r1s0, vmw0_s0, VLEN) ;	\
  __vr vrsumU_r1s1 = _vel_vfsums_vvl(VRSUMTOKEN ## _r1s1, VLEN) ;		\
  __vr vrsumU_r1s2 = _vel_vfsums_vvml(VRSUMTOKEN ## _r1s2, vmw1_s2, VLEN) ;	\
  __vr vrsumU_r2s0 = _vel_vfsums_vvml(VRSUMTOKEN ## _r2s0, vmw0_s0, VLEN) ;	\
  __vr vrsumU_r2s1 = _vel_vfsums_vvl(VRSUMTOKEN ## _r2s1, VLEN) ;		\
  __vr vrsumU_r2s2 = _vel_vfsums_vvml(VRSUMTOKEN ## _r2s2, vmw1_s2, VLEN) ;	\
...
#define VSUM_STORE_3X3_LOWER(VRSUMTOKEN, KERNELINDEX)					\
  {											\
  __vr vrsumL_r0s0 = _vel_vfsums_vvml(_vel_vsll_vvsl(VRSUMTOKEN ## _r0s0,32, VLEN), vmw0_s0, VLEN) ;	\
  __vr vrsumL_r0s1 = _vel_vfsums_vvl(_vel_vsll_vvsl(VRSUMTOKEN ## _r0s1,32, VLEN), VLEN) ;		\
  __vr vrsumL_r0s2 = _vel_vfsums_vvml(_vel_vsll_vvsl(VRSUMTOKEN ## _r0s2,32, VLEN), vmw1_s2, VLEN) ;	\
  __vr vrsumL_r1s0 = _vel_vfsums_vvml(_vel_vsll_vvsl(VRSUMTOKEN ## _r1s0,32, VLEN), vmw0_s0, VLEN) ;	\
  __vr vrsumL_r1s1 = _vel_vfsums_vvl(_vel_vsll_vvsl(VRSUMTOKEN ## _r1s1,32, VLEN), VLEN) ;		\
  __vr vrsumL_r1s2 = _vel_vfsums_vvml(_vel_vsll_vvsl(VRSUMTOKEN ## _r1s2,32, VLEN), vmw1_s2, VLEN) ;	\
  __vr vrsumL_r2s0 = _vel_vfsums_vvml(_vel_vsll_vvsl(VRSUMTOKEN ## _r2s0,32, VLEN), vmw0_s0, VLEN) ;	\
  __vr vrsumL_r2s1 = _vel_vfsums_vvl(_vel_vsll_vvsl(VRSUMTOKEN ## _r2s1,32, VLEN), VLEN) ;		\
  __vr vrsumL_r2s2 = _vel_vfsums_vvml(_vel_vsll_vvsl(VRSUMTOKEN ## _r2s2,32, VLEN), vmw1_s2, VLEN) ;	\
