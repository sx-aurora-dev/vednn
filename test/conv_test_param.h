...
inline void testconvForward_init( struct testconvForward *pConv );
inline void testconvForward_alloc( struct testconvForward *pConv, struct param const* pNw, int const flagBias, filterLayout_t filter_layout );
inline void testconvForward_dumpParms( struct testconvForward const *pConv, int const flagBias );
inline void testconvForward_randomData( struct testconvForward const* pConv, int const flagBias );
inline void testconvForward_refcalcs( struct testconvForward *pConvArray, int const nEntry ); ///< ->pBufRef
       void testconvForward_vednncalcs( struct testconvForward *pConvArray, int const nEntry );
inline void testconvForward_free( struct testconvForward *pConv, int const flagBias);

inline void testconvBackwardData_init( struct testconvBackwardData *pConv );
inline void testconvBackwardData_alloc( struct testconvBackwardData *pConv, struct param const* pNw, filterLayout_t filter_layout );
inline void testconvBackwardData_randomData( struct testconvBackwardData const* pConv );
inline void testconvBackwardData_dumpParms( struct testconvBackwardData const *pConv );
inline void testconvBackwardData_refcalcs( struct testconvBackwardData *pConvArray, int const nEntry );
       void testconvBackwardData_vednncalcs( struct testconvBackwardData *pConvArray, int const nEntry );
inline void testconvBackwardData_free( struct testconvBackwardData *pConv );

inline void testconvBackwardFilter_init( struct testconvBackwardFilter *pConv );
inline void testconvBackwardFilter_alloc( struct testconvBackwardFilter *pConv, struct param const* pNw, filterLayout_t filter_layout );
inline void testconvBackwardFilter_randomData( struct testconvBackwardFilter const* pConv );
inline void testconvBackwardFilter_dumpParms( struct testconvBackwardFilter const *pConv );
inline void testconvBackwardFilter_refcalcs( struct testconvBackwardFilter *pConvArray, int const nEntry );
       void testconvBackwardFilter_vednncalcs( struct testconvBackwardFilter *pConvArray, int const nEntry );
inline void testconvBackwardFilter_free( struct testconvBackwardFilter *pConv );
