...
static inline void testconvForward_init( struct testconvForward *pConv );
static inline void testconvForward_alloc( struct testconvForward *pConv, struct param const* pNw, int const flagBias );
static inline void testconvForward_dumpParms( struct testconvForward const *pConv, int const flagBias );
static inline void testconvForward_randomData( struct testconvForward const* pConv, int const flagBias );
static inline void testconvForward_refcalcs( struct testconvForward *pConvArray, int const nEntry ); ///< ->pBufRef
static inline void testconvForward_vednncalcs( struct testconvForward *pConvArray, int const nEntry );
static inline void testconvForward_free( struct testconvForward *pConv, int const flagBias);

static inline void testconvBackwardData_init( struct testconvBackwardData *pConv );
static inline void testconvBackwardData_alloc( struct testconvBackwardData *pConv, struct param const* pNw );
static inline void testconvBackwardData_randomData( struct testconvBackwardData const* pConv );
static inline void testconvBackwardData_dumpParms( struct testconvBackwardData const *pConv );
static inline void testconvBackwardData_refcalcs( struct testconvBackwardData *pConvArray, int const nEntry );
static inline void testconvBackwardData_vednncalcs( struct testconvBackwardData *pConvArray, int const nEntry );
static inline void testconvBackwardData_free( struct testconvBackwardData *pConv );

static inline void testconvBackwardFilter_init( struct testconvBackwardFilter *pConv );
static inline void testconvBackwardFilter_alloc( struct testconvBackwardFilter *pConv, struct param const* pNw );
static inline void testconvBackwardFilter_randomData( struct testconvBackwardFilter const* pConv );
static inline void testconvBackwardFilter_dumpParms( struct testconvBackwardFilter const *pConv );
static inline void testconvBackwardFilter_refcalcs( struct testconvBackwardFilter *pConvArray, int const nEntry );
static inline void testconvBackwardFilter_vednncalcs( struct testconvBackwardFilter *pConvArray, int const nEntry );
static inline void testconvBackwardFilter_free( struct testconvBackwardFilter *pConv );

static inline unsigned long long count_ops(struct param const* p); // as in bench-dnn
...
static inline void param_cstr_error_exit(){
