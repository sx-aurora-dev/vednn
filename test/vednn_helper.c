...
/* ----------------------------------------------------------------------- */
vednnError_t
createKernelParam(vednnFilterParam_t **ppParam, dataType_t dtype, filterLayout_t filter_layout, int inChannel, int outChannel, int width, int height)
{
